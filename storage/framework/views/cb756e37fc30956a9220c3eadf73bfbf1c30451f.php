...
$message = $__bag->first($__errorArgs[0]); ?>
                            <small class="text-danger">Please insert a value here</small>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input name="survey[email]" type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter You Email">

                                <small id="emailHelp" class="form-text text-muted">Insert your email here</small>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\public-survey\resources\views/survey/show.blade.php ENDPATH**/ ?>